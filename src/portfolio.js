  ...
  experience: [
    {
      ...
      descBullets: [
        ...
        "Successfully helped in implementing a new feature in airline pre-booking that improved user experience and increased customer engagement by 20%",
    ...
    },
    {
      ...
      descBullets: [
        "Led the design and development of a full-stack microservice web application utility tool using .NET core REST APIs, AngularJS, NoSQL integrated with OAuth, RBAC simplified as part of the framework team, which increased performance efficiency for backend support team by 50%.",
        ...
        "Leveraged my expertise in n .NET/C#/MyQL/NoSQL/Angular to create REST API designs and contracts for creating utility tools and services (SSO - Service, Subcription Service, User-Management Service) maintaining 100% code quality and minimum bug density using SONAR, as per user requirements and API scope with extensive testing.",
    ...
    },
    {
      ...
      descBullets: [
        ...
        "Worked on production level bugs to improve various use-cases and improve system performance and maintaining open bug count to minimum.",
